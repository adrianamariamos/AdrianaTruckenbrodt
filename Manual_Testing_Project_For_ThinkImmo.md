<h1>Testing Project for ThinkImmo</h1>

The scope of the final project for ITF Manual Testing Course is to use all gained knowledge throught the course and apply them in practice, using a live application

Application under test: ThinkImmo
...
The Test Plan is designed to describe all details of testing for all the modules from the ThinkImmo Demo application.
